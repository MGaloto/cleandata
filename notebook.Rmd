...
```{python}
fig = px.scatter(df_caba, x="surface_total_in_m2", y="price_usd_per_m2", color="property_type",
...
df_caba_filter_apartment["ambientes"] = df_caba_filter_apartment["ambientes"].astype(str)
fig = px.scatter(df_caba_filter_apartment, x="surface_covered_in_m2", y="price_usd_per_m2", color="ambientes",
                  hover_data=['property_type'], title = 'Scatter Plot Precio y Superficie Separado por Ambientes para apartment')
fig.show()
